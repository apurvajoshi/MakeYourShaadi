        ...
        if (options.buttons) {
            ...
            calendarNavHtml += '<div class=\"ui-widget-header wc-toolbar\">';
              ...
              calendarNavHtml += '<div class=\"wc-nav\">';
                calendarNavHtml += '<button class=\"wc-prev\"  style=\"border-style:none\">' + options.buttonText.lastWeek + '</button>';
                calendarNavHtml += '<button class=\"wc-today\" style=\"border-style:none\">' + options.buttonText.today + '</button>';
                calendarNavHtml += '<button class=\"wc-next\" style=\"border-style:none\">' + options.buttonText.nextWeek + '</button>';
              calendarNavHtml += '</div>';
